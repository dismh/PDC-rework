  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-gray-900 to-gray-700 dark:from-slate-300 dark:to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent sm:text-5xl md:text-6xl lg:text-7xl"
      >
        Cash Prizes
      </motion.h1>

      <div className="mt-8 flex flex-wrap gap-6 justify-center items-center w-full px-4">
        {/* Runner Up Team Card */}
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.5, duration: 0.8, ease: "easeInOut" }}
          className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full sm:w-64 text-center border border-gray-300 dark:border-gray-600"
        >
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8 w-full sm:w-72 text-center border-4 border-purple-500 dark:border-cyan-500 transform scale-105"
        >
